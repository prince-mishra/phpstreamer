...
(function (factory) {
    ...
    $.extend($.fn.modal.Constructor.prototype, {
        initLinks: function () {
            ...
            console.log("initlinks options", options);
            ...
            console.log("initlinks", this.$links);
        ...
        loadImage: function () {
            ...
            KC.url.updateUrl({"action":"loadImage", "url":url});
    ...
    $(function () {
        $(document.body).on(
            ...
            function (e) {
                var $this = $(this),//modal gallery
                    options = $this.data(),
                    modal = $(options.target),
                    data = modal.data('modal'),
                    link;//a rel (parent of img)
                if (!data) {
                ...
                if (link.length && modal.length) {
                    ...
                    //options.delegate = link[0] === this ? options.delegator : undefined;
                    // change this
                    options.delegate = link[0] !== this ? options.delegator : undefined;
                    if (data) {
                    ...
                    console.log("from a", this, $this, options, link);
                    modal.modal(options);
                    //options.action = 'launchdialog';
                    //KC.url.updateUrl(options);
                }
            }
        );
    });
